...
- **Separação entre Preço de Venda e Preço de Compra:** O _preço de venda_ pertence ao produto (cardápio). O _preço de compra_ pertence a cada LoteEstoque, visto que os custos de aquisição flutuam a cada remessa com fornecedores.
